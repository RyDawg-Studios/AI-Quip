...
class LobbyLevel(Level):
    def __init__(self, man, pde):
        ...
        if self.pde.game.player.ishost:
            self.objectManager.add_object(obj=ButtonElement(man=man,pde=pde, position=[320, 180], scale=[64,32],useCenterForPosition=True, sprite=r"data\aigame\assets\sprites\ui\start.png", bind=self.pde.game.start_game))
        else:
